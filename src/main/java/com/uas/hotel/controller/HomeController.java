...
//        return "/index";
        Authentication authentication = HotelManagementSystemApplication.authenticatedUser; //SecurityContextHolder.getContext().getAuthentication();
...
//        return "/index";
        HotelManagementSystemApplication.authenticatedUser = null;
        return "/login";
